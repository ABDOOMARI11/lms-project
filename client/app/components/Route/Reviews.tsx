      ...
      <div className="800px:w-[50%] w-full">
        ...
        <div className="800px:w-[50%] w-full">
          <h3 className={`${styles.title} 800px:!text-[40px]`}>
             <span className="text-gradient text-gradient bg-gradient-to-r from-orange-700 via-orange-400 to-teal-300 text-transparent bg-clip-text"> Our Students Are Our Strength</span>{" "}
